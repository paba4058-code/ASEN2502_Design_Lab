...
for n = 1:Count
    ...
    %% Leakage and Proturbance Contribution to CDo (Student Input Required)
    L_P_Percent = 0.15; %Percent (in decimal form, 0.1 = 10%) of increase of total parasite drag as estimate of leakage and perturbance in fractional value (10% = 0.1)
