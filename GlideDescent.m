function [GlideData] = GlideDescent(LD, Height, Design_Input, ATMOS, Weight_Data, WingLiftModel, WingLiftCurve,WingDragCurve, Count,Plot_Glide_Data)
...
for n = 1:Count
    ...
    bestGlide(n) = Height(n)*LDmax(n); %Post-apogee glide range
...
if Plot_Glide_Data == 1
    ...
    figure(1000)
    for n = 1:Count
        plot([0, GlideData.bestGlide(n)], [Height(n), 0],...
