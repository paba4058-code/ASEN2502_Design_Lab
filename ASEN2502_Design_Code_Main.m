...
% Current Version:  AY26.01 (DO NOT MERGE THIS BRANCH INTO MAIN BRANCH)
% Changes in Current Version:
    %Updated to reflect ASEN 2502 Design Lab Spring 26
...
Design_Input_Filename = "Design Input File_Student_Blank_V26-01.xlsx"; %Name of student aircraft design input file
Benchmark_Data_Filename = "Benchmark_Data_Tempest.xlsx"; %Name of file for benchmark data
...
Benchmark = readtable(Benchmark_Data_Filename,'Sheet','Tempest Drag Polar Truth Data'); %Read in Benchmark "Truth" Data for model validation only
...
%         WingLiftDrag(Design_Input,Airfoil,Count,Plot_Wing_Data); 
% 
...
%         InducedDrag(Design_Input,WingLiftModel,WingLiftCurve,WingDragCurve,WingGeo_Data,Parasite_Drag_Data,Count,Plot_Induced_Data);
% 
...
%     LD_Model = LD_mod2; %You must select one LD model output (from the LD function outputs) to utilize for this analysis
%     Launch_Height = 14.5; %Launch height of glider (meters above ground level)
%     Height = zeros(Count,1); %Initializes starting height for all configurations in design input file (rows)
%     Height(:) = Launch_Height; %Creates array of starting heights for glide
%     [GlideData] = GlideDescent(LD_Model, Height, Design_Input, ATMOS, Weight_Data, WingLiftModel, WingLiftCurve,WingDragCurve,Count,Plot_Glide_Data); %Must select LD of your best model
...
%     [Total_Weight_Stab,Empty_Weight_Stab,STAB_SM_SUMMARY,STAB_Xcg_SUMMARY,STAB_Xnp_SUMMARY,STAB_Vh_SUMMARY,STAB_Vv_SUMMARY,STAB_GLIDE_SUMMARY]...
